...
en | [ko](#serverless-with-oauth-ko)
...
[en](#serverless-with-oauth-en) | ko

![aws flow](https://i.imgur.com/pv7gXCL.png)

### ⚡️AWS Serverless 아키텍처를 통해 구현한 🔒OAuth2.0 프로토콜
AWS Serverless 아키텍처를 통해 _[OAuth2.0 표준 프로토콜 (RFC 6749)](https://tools.ietf.org/html/rfc6749)_ 을 구현하였습니다.

구현한 프로토콜을 통해 인가된 사용자만이 웹 리소스에 접근할 수 있게 되었으며, 이는 곧 _안전한 웹 서비스_ 를 구현하였음을 의미합니다.
